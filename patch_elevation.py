#!/usr/bin/env python3
"""One-off: backfill elevation fields into existing activities without a full resync.

Re-fetches activities for the full historical range (one bulk API call) and
merges min/max/avg elevation into garmin/data.json, leaving wellness untouched.
"""
...
def main():
    ...
    print(f"Patched elevation fields into {updated} activities.")
